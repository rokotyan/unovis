...
export const colors: string[] = globalThis.UNOVIS_COLORS ?? ['#4D8CFD', '#FF6B7E', '#F4B83E', '#A6CC74', '#00C19A', '#6859BE']
export const colorsDark: string[] = globalThis.UNOVIS_COLORS_DARK ?? ['#4D8CFD', '#FF6B7E', '#FFC16D', '#A6CC74', '#00C19A', '#7887E0']
